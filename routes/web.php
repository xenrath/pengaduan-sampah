...
Route::post('reset-password/proses', [\App\Http\Controllers\AuthController::class, 'reset_password_proses']);
Route::post('reset-password/kode', [\App\Http\Controllers\AuthController::class, 'reset_password_kode']);
Route::get('new-password', [\App\Http\Controllers\AuthController::class, 'new_password']);
Route::post('new-password', [\App\Http\Controllers\AuthController::class, 'new_password_proses']);
